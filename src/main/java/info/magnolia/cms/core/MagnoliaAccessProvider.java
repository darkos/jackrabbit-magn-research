...
//                log.warn("The '{}' cannot be used as permissionClass. {}", permissionsClass, warnMessage, defaultPermissionsClass);
//                permissionsClass = defaultPermissionsClass;
...
//            log.warn("The class '{}' doesn't exist. {}", compiledPermissionsClass, warnMessage, defaultPermissionsClass);
//            permissionsClass = defaultPermissionsClass;
//
...
//            log.warn("Cannot instantiate permissionsClass '{}'. {}", permissionsClass, warnMessage, e);
//            permissionsClass = defaultPermissionsClass;
//        }
//    }
